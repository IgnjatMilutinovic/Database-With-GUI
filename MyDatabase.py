...
class MyDatabase():
    ...
    def fill_tables(self):
        ...
        self.cursor.execute("INSERT INTO profesori(ime,prezime,email) VALUES ('Branimir','Trenkic','branimirtrenkic@gmail.com'), ('Nenad','Korolija','nenadkorolija@gmail.com')")
